...
|---|---|---|
| `data/dictionnaire_entries.json` | `parse.py` | 956 parsed and tagged Flaubert entries |
| `data/embeddings.npz` | `embed.py` | CamemBERT sentence embeddings (956 × 768) |
...
The 956 entries were cleaned through a systematic audit of the Gutenberg plain-text
